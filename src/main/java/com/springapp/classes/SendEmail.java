...
public class SendEmail {
    // 发件人的 邮箱 和 密码
    public static String myEmailAccount = "bev@formal-tech.com";
    public static String myEmailPassword = "Pl,okm123";

    // 发件人邮箱的 SMTP 服务器地址, 必须准确, 不同邮件服务器地址不同, 一般格式为: smtp.xxx.com
    public static String myEmailSMTPHost = "smtp.exmail.qq.com";//腾讯企业邮

    // 收件人邮箱
    public static String receiveMailAccount = "bev@formal-tech.com";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail, String targetPath) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "百威运维", "UTF-8"));
...
*/
        ...
        DataHandler dh2 = new DataHandler(new FileDataSource(targetPath));  // 读取本地文件
